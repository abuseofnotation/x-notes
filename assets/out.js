...
define("00/film", ["require", "exports", "engine", "utils", "maps"], function (require, exports, engine_js_2, utils_js_1, maps_1) {
    ...
    exports.film = (0, utils_js_1.compose)([
        (0, engine_js_2.init)(config),
        (0, engine_js_2.layer)(1, colors, (0, maps_1.constant)(config, 1)),
        (0, engine_js_2.layer)(10, colors, (0, maps_1.constant)(config, 10000)),
        (0, engine_js_2.layer)(50, colors, (0, maps_1.constant)(config, 10000)),
...
define("00/flare", ["require", "exports", "engine", "utils", "maps"], function (require, exports, engine_js_3, utils_js_2, maps_2) {
    ...
    var flare = function () { return (0, utils_js_2.compose)([
        (0, engine_js_3.init)(config),
        (0, engine_js_3.layer)(30, colors, (0, maps_2.constant)(config, 30 * 20)),
        (0, engine_js_3.layer)(2, colors, (0, maps_2.centerProximity)(config)),
        (0, engine_js_3.layer)(2, colors, (0, maps_2.centerProximity)(config)),
        (0, engine_js_3.layer)(3, colors, (0, maps_2.centerProximity)(config)),
        (0, engine_js_3.layer)(5, colors, (0, maps_2.centerProximity)(config)),
        (0, engine_js_3.layer)(7, colors, (0, maps_2.centerProximity)(config)),
...
define("00/lare", ["require", "exports", "engine", "utils", "maps"], function (require, exports, engine_js_4, utils_js_3, maps_3) {
    ...
    var lare = function () { return (0, utils_js_3.compose)([
        (0, engine_js_4.init)(config),
        (0, engine_js_4.layer)(1, colors, (0, maps_3.constant)(config, 10)),
        (0, engine_js_4.layer)(2, colors, cutLine(6, (0, maps_3.constant)(config, 50))),
        (0, engine_js_4.layer)(10, colors, cutLine(3, (0, maps_3.constant)(config, 30 * 20))),
        (0, engine_js_4.layer)(5, colors, cutLine(4, (0, maps_3.constant)(config, 30 * 20))),
...
define("00/scope", ["require", "exports", "engine", "utils", "maps"], function (require, exports, engine_1, utils_1, maps_4) {
    ...
    var scope = function () {
        ...
        return (0, utils_1.compose)([
            ...
            (0, engine_1.layer)(60, colors, (0, maps_4.verticalSymmetry)(config, 100000)),
            (0, engine_1.layer)(60, colors, (0, maps_4.constant)(config, 50000)),
            (0, engine_1.layer)(10, colors, (0, maps_4.verticalSymmetry)(config, 3000)),
            (0, engine_1.layer)(20, colors, (0, maps_4.verticalSymmetry)(config, 6000)),
            (0, engine_1.layer)(2, colors, (0, maps_4.verticalSymmetry)(config, 100)),
            (0, engine_1.layer)(1, colors, (0, maps_4.constant)(config, 10)),
...
define("00/drope", ["require", "exports", "engine", "utils", "maps", "processors"], function (require, exports, engine_js_5, utils_js_4, maps_5, processors_1) {
    ...
    var drope = function () {
        ...
        return (0, utils_js_4.compose)([
            (0, engine_js_5.init)(config),
            (0, engine_js_5.layer)(2, colors, (0, maps_5.cornerProximity)(config, 0.1)),
            (0, engine_js_5.layer)(3, colors, (0, maps_5.cornerProximity)(config, 0.1)),
            (0, engine_js_5.layer)(10, colors, (0, maps_5.symmetry)(config, 5000)),
            (0, engine_js_5.layer)(20, colors, (0, maps_5.symmetry)(config, 7000)),
            (0, engine_js_5.layer)(30, colors, (0, maps_5.centerProximity)(config, 10)),
...
define("index", ["require", "exports", "00/film", "00/flare", "00/lare", "00/scope", "00/drope"], function (require, exports, film_js_1, flare_js_1, lare_js_1, scope_js_1, drope_js_1) {
    ...
    var pieces = {
        film: film_js_1.film,
        flare: flare_js_1.flare,
        lare: lare_js_1.lare,
        drope: drope_js_1.drope,
        scope: scope_js_1.scope
    };
    var render = function () {
        Object.keys(pieces).forEach(function (piece) {
            Array.prototype.slice.call(document.getElementsByClassName(piece)).forEach(function (element) {
                element.appendChild(pieces[piece]());
            });
        });
    };
    render();
